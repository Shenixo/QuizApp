...
const Progress = () => {
  ...
  <h1 className="absolute text-red text-6xl font-bold <div className="flex items-center justify-center w-full h-[100vh] relative bg-[#0b1012]">
  <progress value={count} max={100} className="h-16 w-[20rem] relative z-10" />
  <h1 className="absolute text-white text-4xl font-bold mix-blend-exclusion">
    Code Hashira
  </h1>
</div>
">

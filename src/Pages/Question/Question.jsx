      ...
      <div className=" w-[92%] sm:w-[82%] mx-auto placeholder-stone-200 pt-16 sm:pt-24">
        ...
        <div className="grid grid-cols-break lg:grid-cols-cols gap-[6rem] w-full">
          <div>
            ...
            <Button className= "max-w-max  p-[.5rem] px-3 font-thin text-[1.2rem]  rounded-[.16rem] " onClick={() => handleSubmitNextQuestion("+")}>Next <FontAwesomeIcon icon={faAnglesRight} className="text-[1.2rem]" /></Button>
